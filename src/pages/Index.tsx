...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-soft-beige">
      ...
      {/* Stats Section */}
      <section className="py-16 bg-muted-olive">
          ...
          <div className="text-center text-off-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mb-2">12,845</div>
                <p className="text-lg opacity-90">活躍用戶</p>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mb-2">156</div>
                <p className="text-lg opacity-90">可選挑戰</p>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mb-2">89%</div>
                <p className="text-lg opacity-90">完成率</p>
              </div>
            </div>
          </div>
        </div>
